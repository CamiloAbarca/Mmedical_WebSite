        ...
        <b-container class="my-5">
            <b-row class="justify-content-center">
                <b-col md="5" class="contact-info p-4 mb-4 mb-md-0 text-center">
                    ...
                    <p><b-icon icon="envelope-fill" class="mr-2"></b-icon> <strong>Email:</strong> contacto@mmedical.cl
                    </p>
                    <p><b-icon icon="telephone-fill" class="mr-2"></b-icon> <strong>Teléfono:</strong> +56 2 6469 3204
                    </p>
                    <p><b-icon icon="whatsapp" class="mr-2"></b-icon> <strong>WhatsApp:</strong> +56 9 9197 2233
                    </p>
                    ...
                    <div class="social-icons">
                        ...
                        <a href="https://www.facebook.com/profile.php?id=100063562029247#" class="social-icon-link mx-2"
                            aria-label="Facebook"><b-icon icon="facebook"></b-icon></a>
                        <a href="https://www.instagram.com/mmedical.cl/" class="social-icon-link mx-2"
                            aria-label="Instagram"><b-icon icon="instagram"></b-icon></a>
                        <a href="https://wa.me/56991972233" class="social-icon-link mx-2" aria-label="WhatsApp"><b-icon
                ...
                <b-col md="7" class="contact-form p-4">
                    <b-form @submit.prevent="submitForm">
                        ...
                        <b-button type="submit" class="w-100 mt-3" style="background-color: #db3545;">
                            Enviar Mensaje
                        </b-button>
                    </b-form>
                </b-col>
    ...
    methods: {
        async submitForm() {
            try {
                ...
                const response = await axios.post('https://mmedical.cl/enviar-correo.php', this.form);
